  ...
  return (
    <main className="min-h-screen flex flex-col items-center">
      ...
      <section className="relative flex flex-col items-center text-center gap-8 py-24 px-6 md:px-12 animate-fadeIn">
        ...
        <p className="text-lg md:text-xl text-gray-600 max-w-3xl animate-fadeIn delay-200">
          {t("description")}
        </p>
      </section>
      ...
      <section className="flex flex-col lg:flex-row items-center gap-12 py-24 px-6 md:px-12 w-full max-w-7xl">
        ...
        <div className="w-full lg:w-1/2">
          <h2 className="text-4xl font-semibold text-green-700 mb-6">{t("mountain_trail.title")}</h2>
          <p className="text-gray-700 text-lg leading-relaxed">{t("mountain_trail.description")}</p>
        </div>
      </section>
      ...
      <section className="flex flex-col-reverse lg:flex-row items-center gap-12 py-24 px-6 md:px-12 w-full max-w-7xl">
        ...
        <div className="w-full lg:w-1/2">
          <h2 className="text-4xl font-semibold text-green-700 mb-6">{t("rules.title")}</h2>
