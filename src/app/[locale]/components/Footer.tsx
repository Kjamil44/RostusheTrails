            ...
            <div className="container mx-auto px-8 flex flex-col md:flex-row justify-between items-start gap-6">
                ...
                <div>
                    ...
                    <ul className="space-y-2">
                        ...
                        <li>
                            <Link href={`/${locale}/trails/twentyseven-km`} className="hover:text-green-500">
                                {t("27Km")}
                            </Link>
                        </li>
                        <li>
                        ...
                        <li>
                            <Link href={`/${locale}/gallery`} className="hover:text-green-500">
                                {t("gallery")}
                            </Link>
                        </li>
                        <li>
                            <Link href={`/${locale}/accommodation`} className="hover:text-green-500">
                                {t("accommodation")}
                            </Link>
                        </li>
                        <li>
